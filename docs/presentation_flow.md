...
- **Timeline**:
  ...
  - **2:00 - 5:00**: Codebase tour. Open `boc_agent/runtime/` and show the Planner, Executor, and Tool Registry classes. Open `tests/` and show the 183-test suite coverage.
